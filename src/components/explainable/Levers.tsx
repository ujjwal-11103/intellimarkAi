            ...
            <div className="absolute inset-0 flex items-center justify-center pt-8">
              <div className="text-center">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-800 leading-tight">
                  Up to 2/3<sup className="text-lg">rd</sup> topline
                </h2>
        ...
        <div className="flex flex-wrap justify-center items-center gap-0">
          {levers.map((lever, index) => (
            <div key={index} className="relative group">
              {/* Lever Container */}
              <div 
                className="relative bg-white border-2 border-purple-300 hover:border-purple-500 transition-all duration-300 transform hover:scale-105"
                style={{
              ...
              >
                {/* Content */}
                <div className="absolute inset-0 flex flex-col justify-center pl-8 pr-6">
                ...
                {/* Hover tooltip */}
                <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10">
                  <div className="bg-purple-600 text-white text-xs rounded-lg py-2 px-3 shadow-lg whitespace-nowrap">
                    {lever.description}

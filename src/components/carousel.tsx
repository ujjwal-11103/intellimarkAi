...
const slides: Slide[] = [
  ...
  // },
  {
    id: 2,
    cards: [
  { id: 5, type: 'feature', title: 'Revenue Growth Management', subtitle: 'Unlock Real Growth', description: 'Ready to deploy AI to unlock growth, profitability and sales efficiency', image: 'https://images.pexels.com/photos/7947758/pexels-photo-7947758.jpeg?auto=compress&cs=tinysrgb&w=800', icon: <Zap className="w-5 h-5 sm:w-6 sm:h-6" /> , link: '/RevenueGrowthManagement'},
  { id: 6, type: 'location', title: 'Advanced forecasting and planning', subtitle: 'Insightful Planning', description: 'Advanced forecasting engine. 30% higher forecast, 20% lesser inventory holding.', image: 'https://images.pexels.com/photos/7054417/pexels-photo-7054417.jpeg?auto=compress&cs=tinysrgb&w=800', icon: <MapPin className="w-5 h-5 sm:w-6 sm:h-6" />, link: '/forecasting' },
  { id: 7, type: 'success', title: 'Assortment Recommendation Engine.', stats: 'World\'s biggest brands Ready', description: 'Assortment Recommendation Engine. Deployed over 5,00,000 stores.', image: 'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&cs=tinysrgb&w=800', icon: <ArrowRight className="w-5 h-5 sm:w-6 sm:h-6" />, link: '/recommendation' },

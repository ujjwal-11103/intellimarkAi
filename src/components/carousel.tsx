...
const slides: Slide[] = [
  ...
  { id: 7, type: 'success', title: 'Assortment Recommendation Engine.', stats: 'World\'s biggest brands Ready', description: 'Deployed over 5,00,000 stores.', image: 'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&cs=tinysrgb&w=800', icon: <ArrowRight className="w-5 h-5 sm:w-6 sm:h-6" />, link: '/recommendation' },

  ...
  const resources: Study[] = [
    {
      ...
      description: 'Teresa Forecasting Engine combining e-commerce scrape (Amazon), ad-spend, competitor prices, and category rankings to stabilize forecasts and cut OOS.',
    ...
    },
    {
      ...
      description: 'City×Product-level forecasting and dynamic distributor norms to cut unsold inventory and rationalize product–market variants.',
      image: 'https://images.pexels.com/photos/213162/pexels-photo-213162.jpeg?auto=compress&cs=tinysrgb&w=800',
    },
    {
      id: 'car-wash-forecasting-us',
      type: 'CASE STUDY',
      title: '40% Forecasting Accuracy for US Car Wash Company using Weather-based Seasonal Patterns',
      description: 'Feature Engineering Engine incorporating 14 weather datasets to boost 90-day demand forecast accuracy and unlock working capital.',
      image: 'https://images.pexels.com/photos/4870731/pexels-photo-4870731.jpeg?auto=compress&cs=tinysrgb&w=800',
    }
  ];
